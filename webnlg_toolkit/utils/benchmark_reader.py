...
class Entry:
    ...
    def __init__(self, category, size, eid, shape, shape_type):
        ...
        self.generatedtripleset = Tripleset()
        self.lexs = []
        self.dbpedialinks = []
        self.links = []
    ...
    def fill_generatedtriple(self, xml_t):
        self.generatedtripleset.fill_tripleset(xml_t)
...
class Benchmark:
        ...
        for file in fileslist:
            ...
            for xml_entry in root.iter('entry'):
                ...
                for child in xml_entry:
                    ...
                    elif child.tag == 'generatedtripleset':
                        entry.fill_generatedtriple(child)
                    elif child.tag == 'lex':
    ...
    def to_dict(self):
        ...
        for entry in self.entries:
            ...
            for triple in entry.generatedtripleset.triples:
                gen_tripleset.append({'subject': triple.s, 'property': triple.p, 'object': triple.o})
            ...
            data['entries'].append({
                ...
                'generatedtripleset': gen_tripleset,
    ...
    def b2xml(self, path, filename, recalc_id=True):
        ...
        for index, entry in enumerate(self.entries):
            ...
            gtripleset_xml = Et.SubElement(entry_xml, 'generatedtripleset')
            for gtriple in entry.generatedtripleset.triples:
                gtriple_xml = Et.SubElement(gtripleset_xml, 'gtriple')
                gtriple_xml.text = gtriple.s + ' | ' + gtriple.p + ' | ' + gtriple.o
